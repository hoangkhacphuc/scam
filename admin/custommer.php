...
<body onload="time()">
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="myNavbar">
                <ul class="nav navbar-nav navbar-right">
                    <li class="active"><a href="./custommer.php" data-toggle="tooltip" data-placement="bottom"
                    ...
                    <li><a href="./report.php" data-toggle="tooltip" data-placement="bottom" title="TỐ CÁO">TỐ CÁO</a>
                    </li>
                    <li>
    ...
    <div class="container-fluid al">
        <div id="clock"></div>
        <Br>
        <p class="timkiemnhanvien"><b>TÌM KIẾM CỘNG TÁC VIÊN:</b></p><Br><Br>
        ...
        <table class="table table-bordered" id="myTable">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><?= $user['role'] ?></td>
                    <td>
                        <a class="add" title="Lưu Lại" data-toggle="tooltip" data-id="<?= $user['id'] ?>"><i class="fa fa-floppy-o"
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            var actions = '<a class="add" title="Lưu Lại" data-toggle="tooltip" data-id="-1"><i class="fa fa-floppy-o" aria-hidden="true"></i></a>'+
                        '<a class="edit" title="Sửa" data-toggle="tooltip"><i class="fa fa-pencil" aria-hidden="true"></i></a>'+
                        '<a class="delete" title="Xóa" data-toggle="tooltip" data-id="-1"><i class="fa fa-trash-o" aria-hidden="true"></i></a>';
            ...
            $(document).on("click", ".add", function () {
                ...
                // if (!empty) {
                //     if (input.eq(0).attr('data-edit') == 'true')
                //     {
                //         input.each(function () {
            ...
            $(document).on("click", ".edit", function () {
                $(this).parents("tr").find("td:not(:last-child)").each(function () {
                    $(this).html('<input data-edit="true" type="text" class="form-control" value="' + $(this)
                        .text() + '">');
                });
                $(this).parents("tr").find(".add, .edit").toggle();
            ...
            jQuery(function () {
                ...
                $(document).on('click', ".add", function () {
                    ...
                    let gioitinh = input.eq(1).val();
                    let namsinh = input.eq(2).val();
                    let diachi = input.eq(3).val();
                    let chucvu = input.eq(4).val();
                    ...
                    let tg = $(this).parents("tr").find(".add, .edit");
                    let btn = $(this).parents("tr").find(".add, .edit, .delete");

                    $.post('../BE.php?api=CreateMember', data, function (response) {
            ...
            $(document).on("click", ".delete", function () {
                ...
                if ($('.add-new').attr('disabled') == 'disabled') {
                    tr.remove();
                    $(".add-new").removeAttr("disabled");
                    return;
                }
                ...
                $.post('../BE.php?api=DeleteUser', data, function (response) {
                        response = JSON.parse(response);
                        if (response.status == true) {
                            tr.remove();
                            $(".add-new").removeAttr("disabled");
